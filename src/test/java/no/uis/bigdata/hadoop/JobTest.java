...
import no.uis.bigdata.hadoop.model.avro.RedirectType;
...
//    @Value("#{T(no.uis.bigdata.hadoop.model.avro.Page).Schema}")
//    private String d;
...
//        dataFileWriter.create(no.uis.bigdata.hadoop.model.avro.Page.SCHEMA$, new File("/Users/maziarkaveh/Develop/codes/uis/bigdata/hadoop/data/s/t.txt"));
