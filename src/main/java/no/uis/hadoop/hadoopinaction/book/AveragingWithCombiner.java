...
public class AveragingWithCombiner extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int res = ToolRunner.run(new Configuration(), new AveragingWithCombiner(), new String[]{"hdfs://localhost:9000/user/hadoop/dir/apat63_99.txt", "/Users/maziarkaveh/Develop/codes/uis/bigdata/hadoop/data/" + new Random().nextInt() });
