...
public class DiscussionThreadingInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    public DiscussionThreadingInfo() {
    }

    // Used by DatumWriter.  Applications should not call.
    public DiscussionThreadingInfo(no.uis.bigdata.hadoop.common.model.jaxb.DiscussionThreadingInfo discussionthreadinginfo) {
        if(discussionthreadinginfo==null){
            threadSubject = "";
            threadParent = "";
            threadAncestor = "";
            threadPage = "";
